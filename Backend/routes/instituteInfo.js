...
const storage = new CloudinaryStorage({
    ...
    params: {
        folder: "major-project", // folder where images will be stored
    ...
    async (req, res) => {
        ...
        try {
            ...
            const newInstituteInfo = new InstituteInfo({
                ...req.body,
                createdBy: instituteId,
                institutePictureUrl: req.file ? req.file.path : null, // Cloudinary URL
            });
...
// GET: Fetch institute details by name
router.get("/details", async (req, res) => {
    try {
        let { instituteName } = req.query;
